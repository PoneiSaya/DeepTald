...
class PerseveranzaInfo extends StatelessWidget {
  const PerseveranzaInfo({super.key});
          ...
          Container(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: const [
                  TextSpan(
                    text: "Adherence to previously mentioned ideas and topica that no longer fit the current context.\n\n"
                  ),
                  TextSpan(
                  ...
                  TextSpan(
                    text: "0 = not present.\n1 = doubtful. \n2 = mild: perseverations occur several times during the interview.\n"
                  ),
                  TextSpan(
                    text: "3 = moderate: perseverations occur occasionally and negatively affect exploration.\n"
                  ),
                  TextSpan(
                    text: "4 = severe: perseverations occur so frequently that exploration is greatly impeded.\n"
                  )
                ]
              ),
            ),
